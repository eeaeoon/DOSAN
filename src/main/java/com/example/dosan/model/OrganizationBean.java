...
public class OrganizationBean implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(ORGANIZATION_SEQ, organizationBean.ORGANIZATION_SEQ)
				&& Objects.equals(NAME, organizationBean.NAME) && Objects.equals(TELEPHONE, organizationBean.TELEPHONE)
				&& Objects.equals(ORDER_NUMBER, organizationBean.ORDER_NUMBER);
	}
	...
	public String toString() {
		return "{" + " ORGANIZATION_SEQ='" + getORGANIZATION_SEQ() + "'" + ", NAME='" + getNAME() + "'"
				+ ", TELEPHONE='" + getTELEPHONE() + "'" + ", ORDER_NUMBER='" + getORDER_NUMBER() + "'" + "}";
	}
